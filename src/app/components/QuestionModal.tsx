    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent bg-opacity-40" role="dialog" aria-modal="true">
      <div className="bg-white rounded-md shadow-lg p-6 w-[400px] flex flex-col items-center">
        <svg width="80" height="80" viewBox="0 0 100 100">
          ...
          <text x="50" y="50" textAnchor="middle" dominantBaseline="middle" fontSize="60" fill="#FFCC00" fontWeight="bold" fontFamily="Arial">
            i
          </text>
        </svg>
        <div className="text-yellow-600 text-xl font-medium mt-4" id="modal-title">
          {title}
        </div>
        {message && <div className="text-yellow-600 text-base mt-2">{message}</div>}
